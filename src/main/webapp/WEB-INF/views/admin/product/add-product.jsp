...
<body>
				...
				<div class="create-product">
					...
					<div class="content-create-product">
						<form:form method="post" action="/admin/save-product"
							...
							<br>
							<form:textarea rows="" cols="" style="width:500px;height:150px" id="txtshortDescription1" path="shortDes"></form:textarea>
							<br>
							<br>
							<label>Mô tả chi tiết</label>
							<br>
							<div style="width: 789px; margin-left: 150px;height: 700px">
	...
	<script>
		...
		var editor = '';
		$(document).ready(function(){
			editor = CKEDITOR.replace( 'txtshortDescription1');
		});
	</script>
</body>
</html>