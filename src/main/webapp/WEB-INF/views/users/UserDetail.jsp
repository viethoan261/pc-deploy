			...
			<div class="main-top">
				<div class="left">
					...
					<div class="choose-img">
						<img src="${base}/file/upload/${product.productImages[0].path}" id="img1"> 
						<img src="${base}/file/upload/${product.productImages[1].path}" id="img2"> 
						<img src="${base}/file/upload/${product.productImages[2].path}" id="img3"> 
						<img src="${base}/file/upload/${product.productImages[3].path}" id="img4"> 
						<img src="${base}/file/upload/${product.productImages[4].path}" id="img5">
					</div>
				</div>
				<div class="right">
					<div class="top">
						...
						<del>30.990.000đ</del>
						<br><!-- <span class="span3">CPU:</span><span
						...
						<span class="span3" > ${product.shortDes } </span>
						<span>Bảo hành chính hãng tại Việt Nam 12 tháng</span><br>
